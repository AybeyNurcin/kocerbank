...
(
    ...
    P_ALICITUTAR            OUT KB_HESAPHAREKETI.MIKTAR%TYPE
)
AS
...
BEGIN
    ...
    IF P_RECORDUSER IS NOT NULL
       AND LENGTH(TRIM(P_RECORDUSER)) > 10 THEN
