CREATE TABLE KB_SUBE(
    ID              NUMBER(19)      DEFAULT ON NULL KB_SUBE_SEQ.NEXTVAL NOT NULL PRIMARY KEY,
    SUBEADI         VARCHAR2(50)    NOT NULL,
    SUBEKODU        VARCHAR2(20)    DEFAULT ON NULL ('S' || TO_CHAR(KB_SUBEKODU_SEQ.NEXTVAL, 'FM0000')) UNIQUE,
...
CREATE TABLE KB_PERSONEL (
    ID              NUMBER(19)      DEFAULT ON NULL KB_PERSONEL_SEQ.NEXTVAL NOT NULL PRIMARY KEY,
    AD              VARCHAR2(50)    NOT NULL,
    SOYAD           VARCHAR2(50)    NOT NULL,
    ROL             VARCHAR2(20)    NOT NULL,
    SICIL           VARCHAR2(20)    DEFAULT ON NULL ('KB' || TO_CHAR(KB_SICIL_SEQ.NEXTVAL, 'FM0000')) UNIQUE,
    SIFRE           VARCHAR2(50)    NOT NULL,
    TCKN            VARCHAR2(11)    UNIQUE NOT NULL,
