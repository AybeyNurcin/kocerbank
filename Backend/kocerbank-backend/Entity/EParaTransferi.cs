...
namespace kocerbank_backend.DataAccess
{
    ...
    transaction.Commit();
        ...
        // SWIFT EFT YAPMA (ALICININ BİZİM BANKAMIZDA HESABI YOKSA)

        public ParaTransferDTO SwiftEftTransferiYap(
            ParaTransferDTO dto
        )
        {
            using (
                ...
                )
                {
                    try
                    {
                        ...
                        )
                        {
                            ...
                            // SWIFT EFT'de alıcı tarafında
                            // güncellenen bir iç hesap yoktur.
                            dto.AliciYeniBakiye =
                                0;
